            ...
            using (var scope = webApplication.Services.CreateScope())
            {
                ...
                if (!appContext.Restaurants.Any())
                {
                    appContext.Restaurants.AddRange(
                         new Restaurant { Name = "Pizza Hut", Address = "123 Pizza Street, Hanoi", PhoneNumber = "0901234567", Email = "contact@pizzahut.com", Description = "Famous pizza chain offering a wide variety of pizzas.", IsActive = true, OpenTime = TimeSpan.FromHours(10), CloseTime = TimeSpan.FromHours(22) },
                         new Restaurant { Name = "Burger King", Address = "456 Burger Lane, Hanoi", PhoneNumber = "0907654321", Email = "support@burgerking.com", Description = "Fast food chain known for its flame-grilled burgers.", IsActive = true, OpenTime = TimeSpan.FromHours(8), CloseTime = TimeSpan.FromHours(23) },
                         new Restaurant { Name = "Sushi World", Address = "789 Sushi Boulevard, Hanoi", PhoneNumber = "0908765432", Email = "info@sushiworld.com", Description = "Japanese sushi restaurant with fresh seafood.", IsActive = true, OpenTime = TimeSpan.FromHours(11), CloseTime = TimeSpan.FromHours(21) },
                         new Restaurant { Name = "Pasta House", Address = "321 Pasta Avenue, Hanoi", PhoneNumber = "0901236547", Email = "service@pastahouse.com", Description = "Authentic Italian pasta dishes served in a cozy environment.", IsActive = true, OpenTime = TimeSpan.FromHours(10), CloseTime = TimeSpan.FromHours(22) },
                         new Restaurant { Name = "Grill Master", Address = "654 Grill Road, Hanoi", PhoneNumber = "0908765430", Email = "contact@grillmaster.com", Description = "Grilled meats and vegetables served with sides.", IsActive = true, OpenTime = TimeSpan.FromHours(9), CloseTime = TimeSpan.FromHours(22) },
                         new Restaurant { Name = "Vegan Delights", Address = "987 Vegan Street, Hanoi", PhoneNumber = "0905555555", Email = "hello@vegandelights.com", Description = "Vegan restaurant with plant-based dishes and desserts.", IsActive = true, OpenTime = TimeSpan.FromHours(8), CloseTime = TimeSpan.FromHours(21) },
                         new Restaurant { Name = "Noodle Express", Address = "543 Noodle Place, Hanoi", PhoneNumber = "0903333333", Email = "info@noodleexpress.com", Description = "Asian noodle bar offering quick and tasty meals.", IsActive = true, OpenTime = TimeSpan.FromHours(9), CloseTime = TimeSpan.FromHours(20) },
                         new Restaurant { Name = "Seafood Paradise", Address = "678 Ocean Road, Hanoi", PhoneNumber = "0902222222", Email = "contact@seafoodparadise.com", Description = "Fresh seafood dishes served with traditional flavors.", IsActive = true, OpenTime = TimeSpan.FromHours(10), CloseTime = TimeSpan.FromHours(23) },
                         new Restaurant { Name = "Burger House", Address = "321 Burger Street, Hanoi", PhoneNumber = "0904444444", Email = "support@burgerhouse.com", Description = "Specialty burgers with a range of toppings and sauces.", IsActive = true, OpenTime = TimeSpan.FromHours(10), CloseTime = TimeSpan.FromHours(22) },
                         new Restaurant { Name = "Café Delight", Address = "111 Café Road, Hanoi", PhoneNumber = "0909999999", Email = "info@cafedelight.com", Description = "A cozy café serving coffee, pastries, and light snacks.", IsActive = true, OpenTime = TimeSpan.FromHours(7), CloseTime = TimeSpan.FromHours(20) }
                     );
